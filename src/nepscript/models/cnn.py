...
# class CNNClassifier(nn.Module):
#     """Lightweight CNN for 32x32 grayscale digit classification."""
#     def __init__(self, num_classes: int = 10):
#         super(CNNClassifier, self).__init__()
#         self.conv1 = nn.Conv2d(1, 16, kernel_size=3, padding=1)  # fewer filters
#         self.conv2 = nn.Conv2d(16, 32, kernel_size=3, padding=1) # fewer filters
#         self.fc1 = nn.Linear(32 * 8 * 8, 64)   # smaller hidden layer
