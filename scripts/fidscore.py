...
def main():
    ...
    parser.add_argument('--model', type=str, required=True, help='Path to trained generator model (.pth file)')
    parser.add_argument('--config', type=str, required=True, help='Path to architecture config (.json file)')
